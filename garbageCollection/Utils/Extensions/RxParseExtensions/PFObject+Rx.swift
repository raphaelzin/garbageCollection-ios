...
extension Reactive where Base: PFObject {
    ...
    public func fetch<T: PFObject>() -> Single<T?> {
        return createWithParseCallback({ observer in
...
extension Reactive where Base: PFObject {
    ...
    public func pin(with name: String) -> Observable<Bool> {
        return createWithParseCallback({ observer in
    ...
    public static func unpinAll(_ objects: [PFObject], with name: String) -> Observable<Bool> {
        return createWithParseCallback({ observer in
