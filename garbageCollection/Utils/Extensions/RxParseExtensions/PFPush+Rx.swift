...
extension Reactive where Base: PFPush {
    ...
    public static func sendPushDataToChannel(_ channel: String, withData: [NSObject: AnyObject]) -> Observable<Bool> {
        return createWithParseCallback({ observer in
    ...
    public static func sendPushDataToQuery(_ query: PFQuery<PFInstallation>, withData: [NSObject: AnyObject]) -> Observable<Bool> {
        return createWithParseCallback({ observer in
